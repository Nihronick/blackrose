...
CANONICAL_TITLES = {
    ...
    "demon metal": "Демонический Металл",
    "ragnablood": "Рагнаблад",
    "dragonos": "Драгонос",
    "warfrost": "Варфрост",
    "dark nox": "Тёмный Нокс",
    "cyclos": "Циклос",
    "infinaut": "Инфинаут",
    "blue abyss": "Синяя Бездна",
    "deep abyss": "Синяя Бездна",
    "eldenwood": "Элденвуд",
    "blitz gold": "Блиц Голд",
    "diadust": "Диадаст",
    "gigarock": "Гигарок",
    "eisenhart": "Айзенхарт",
    "aurorite": "Аврорит",
    "auroite": "Аврорит",
    "stone": "Камень Навыков",
    "beast": "Зверь",
    "companion guide": "Гайд по Компаньонам",
    "character stats": "Характеристики Персонажа",
    "latent power": "Скрытая Сила (Латентка)",
    "class": "Классы",
    "constellation": "Созвездия",
    "memory tree": "Древо Памяти",
    "relics": "Реликвии",
    "rage guide": "Руководство по Ярости",
    "story": "Сюжет",
