...
export const GuildProfileModal = ({ profile, onClose }: { profile: GuildMember; onClose: () => void }) => {
          ...
          <div className="p-6">
            ...
            <div className="space-y-5">
              <div className="space-y-1.5">
                <label className="text-xs font-bold uppercase tracking-wider text-muted-foreground ml-1">Никнейм</label>
                <Input 
                  value={nickname} 
              ...
              <div className="space-y-1.5">
                <label className="text-xs font-bold uppercase tracking-wider text-muted-foreground ml-1">Стадия</label>
                <Input 
                  type="number"
                  value={stage} 
              ...
              <div className="p-4 rounded-2xl bg-muted/30 border border-border/10">
                <div className="text-xs font-bold uppercase tracking-wider text-muted-foreground mb-3">Ранг</div>
                <div className="flex items-center gap-3">
                  <div className="size-12 rounded-xl bg-background shadow-sm border border-border/5 flex items-center justify-center">
                    <img src={getRankIcon(profile.rank)} className="size-8 object-contain" alt="rank" />
                  </div>
                  <div>
                    <div className="font-black text-lg">{profile.rank} - {getRankName(profile.rank)}</div>
