          ...
          <div className="p-6">
            ...
            <div className="space-y-4">
              <div className="space-y-1.5">
                <label className="text-xs font-bold uppercase tracking-wider text-muted-foreground ml-1">Игровой никнейм *</label>
                <Input 
                  value={nickname} 
              ...
              <div className="space-y-1.5">
                <label className="text-xs font-bold uppercase tracking-wider text-muted-foreground ml-1">Сообщение (необязательно)</label>
                <textarea 
                  value={message} 
